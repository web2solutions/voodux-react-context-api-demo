...
export default function DashBoardListing (props) {
  ...
  useEffect(() => {
    // got documents
    // console.log('------->>>>> Dashboardlisting.js mouting events', foundation.stopListenTo)
    // listen to add props.entity Collection event on Data API
    onAddDocEventListener = foundation
    ...
    onEditDocEventListener = foundation
    ...
    onDeleteDocEventListener = foundation
